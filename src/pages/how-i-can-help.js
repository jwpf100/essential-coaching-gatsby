...
export const HowICanHelpPage = () => {
  const data = useStaticQuery(graphql`
    query {
      image1: file(relativePath: { eq: "blog/blog1.png" }) {
        childImageSharp {
          fluid(maxWidth: 150) {
  ...
  return (
          ...
          <div className="container pt-5">
            <div className="row justify-content-center align-items-center pb-3 pb-lg-5">
              <div className="col-12 d-flex flex-column">
                ...
                <p className="lead-mobile text-muted ">
                  Each of my clients is unique and has differing requirements
                  but broadly, we work through the following stages:
                </p>
              </div>
            </div>
          </div>
    ...
    <!-- COACHING PROCESS -->
    <!-- xxxxxxxxxxxxxxxx --> */}
        <div id="process" className="features-icons container-fluid">
          <div className="container pb-3 pb-lg-5">
            <div className="row align-items-center">
              ...
              <div className="col-9">
                <h3 className="text-muted text-left">1 - Discover</h3>
                <p className="mb-0 text-left text-muted">
                  In the ‘Discover’ phase, we’ll get clear on your goals,
                  mindset, values and strengths. This is all about who you are
                  and what makes you tick. What’s your vision for the future?
                  What’s your dream?
                </p>
              </div>
            </div>
            <div className="row align-items-center my-3">
              ...
              <div className="col-9">
                <h3 className="text-muted text-left">2 - Design</h3>
                <p className="mb-0 text-left text-muted">
                  In ‘Design’, we’ll spend time defining what’s important to
                  you, exploring your options and what might be holding you
                  back. We’ll create a plan of action and you’ll be clear on
                  your next steps.
                </p>
              </div>
            </div>
            <div className="row align-items-center  my-3">
              ...
              <div className="col-9">
                <h3 className="text-muted text-left">3 - Disrupt</h3>
                <p className="mb-0 text-left text-muted">
                  ‘Disrupt’ is all about taking action! What are you going to do
                  differently? You’ll be taking positive action to build habits
                  and test your ideas and work towards your goals.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-fluid">
          <div className="container">
            <div className="row justify-content-center align-items-center pb-3 pb-lg-5">
              <div className="col-12 d-flex flex-column">
                <p className="lead-mobile text-muted ">
                  Typically, I work with clients over 6-10 sessions; depending
                  on what you’re looking to achieve through coaching. Session
                  frequency is driven by you but it's usually weekly or
                  fortnightly.
                </p>

                <p className="lead-mobile text-muted ">
                  I’m based in South West London but all of my coaching
                  conversations are currently conducted over Zoom. I am flexible
                  with timings during the week and coach during the day and
                  evening.
                </p>
              </div>
            </div>
        ...
        <div className="container-fluid bg-light">
          <div className="container">
            <div className="row justify-content-center align-items-center py-3">
              <div className="col-12 d-flex flex-column">
                <h3 className="text-dark mobile-header py-3">
                  What's included
                </h3>
                <p className="lead-mobile text-muted ">
                  {' '}
                  Whilst each coaching programme is personalised and tailored to
                  you, it will typically include:
                </p>
                <ul className="lead-mobile text-muted ">
                  <li>
                    A package of 6 one-to-one, action-oriented 1-hour coaching
                    sessions, with the flexibility to add more sessions as
                    required.
                  </li>
                  <li>
                    A unique, valuable blend of coaching, psychology and
                    behavioural change insight.
                  </li>
                  <li>
                    Clear goal setting and measurement of progress against
                    these.
                  </li>
                  <li>
                    Structured insight into your strengths and values, which
                    will act as your guiding light for any decisions you make.
                  </li>
                  <li>Resources and exercises to accelerate your progress.</li>
                  <li>
                    Accountability to build positive habits and achieve your
                    goals.
                  </li>
                  <li>
    ...
    <!-- xxxxxxxxxxxxxxxxxxx --> */}
        <div className="container-fluid">
          <div className="container">
            <div className="row justify-content-center align-items-center py-3">
              <div className="col-12 d-flex flex-column">
                <h3 className="text-dark text-center py-3">
          ...
          <div className="row flex-wrap justify-content-center">
            <div className="col-sm-6 col-md-5 col-lg-4">
              <div className="card border-0  mt-4">
                <div className="card-header about-card-header text-center lead">
                  My approach
                </div>
                <div className="card-body text-muted ">
                  <ul>
                    ...
                    <li>
                      Draws on the latest behavioural change research and ideas
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-sm-6 col-md-5 col-lg-4">
              <div className="card border-0">
                ...
                <div className="card-body text-muted ">
                  <ul>
                    <li>
                      Transformational Coaching Diploma (accredited by the
    ...
    // <!-- What you'll get -->
    // <!-- xxxxxxxxxxxxxxxxxxx --> */}
        <div id="process" className="features-icons container-fluid bg-light">
          <div className="container">
            <div className="row justify-content-center align-items-center py-3">
              <div className="col-12 d-flex flex-column">
                <h3 className="text-dark text-center py-3">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-12 col-md-9">
                <p className="mb-0 text-left text-muted">
                  ...
                  style and ways of working so that you can decide whether or
                  not you’ll be a good fit.{' '}
                </p>
                <a href="/what-kind-of-careers-coach-do-i-need">
                  <p className="text-highlight mt-auto">Read blog article...</p>
                </a>
              </div>
            </div>
          </div>
