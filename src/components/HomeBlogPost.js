...
const FeaturedPost = ({ blogInfo }) => {
  ...
  return (
    <div className="col-md-4 mb-4">
      <div className="row h-100 g-0 border rounded overflow-auto flex-column shadow-sm h-md-250 position-relative justify-content-center align-items-center">
